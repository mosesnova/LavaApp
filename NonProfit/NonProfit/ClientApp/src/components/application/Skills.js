...
export class Skills extends Component {
	state = {
		tasks: [
			...
			{ id: "3", taskName: "Go to the gym", type: "inProgress", backgroundColor: "blue" },
			{ id: "4", taskName: "Play baseball", type: "inProgress", backgroundColor: "green" }
		]
	}
	...
	render() {
		...
		return (
			<div className="drag-container">
				<h2 className="head">Skills Drag & Drop</h2>
